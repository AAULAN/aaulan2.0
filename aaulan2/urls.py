...
urlpatterns = [
    ...
    path('register', views.register.RegistrationView.as_view()),
    path('register/activate', views.register.ActivationView.as_view(), name="attendee-registration-email-verification"),
    # path('register/success', views.register.registration_success, name="attendee-registration-success"),
    # path('register/complete', views.registration_complete, name="attendee-registration-complete"),
